  ...
  return (
    <div className='container mt-20'>
        <div className='text-center'>
            <a href="#home" className='w-36 leading-[1] text-[22px] xxs:text-[28px] xs:text-[32px] cursor-pointer mx-auto'>
                Hadayetullah
            </a>

            <div className='w-max flex items-center gap-1 xxs:gap-2 mx-auto text-[11px] xxs:text-sm xs:text-base mt-0 xxs:mt-1 xs:mt-2'>
                <Image src={props.isDarkMode ? assets.mail_icon_dark : assets.mail_icon} alt='' className='w-3 xxs:w-4 xs:w-5' />
                hadayetullah30@gmail.com
            </div>
        </div>

        <div className='text-center flex flex-col md:flex-row items-center justify-center xxs:justify-between border-t border-gray-400 mx-[5%] md:mx-[10%] mt-4 xxs:mt-8 py-4'>
            <p className='leading-[1.3]'>@ 2025 Md. Hadayetullah. All rights reserved.</p>
